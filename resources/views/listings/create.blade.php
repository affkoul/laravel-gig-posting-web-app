<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
      ...
      <p class="mb-4">Post a gig to find a partner</p>
    </header>
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title"
          placeholder="Example: Senior Oil Field Operator" value="{{old('title')}}" />
      ...
      <div class="mb-6">
        <label for="tags" class="inline-block text-lg mb-2">
          Tags (min 3 max 4 Comma Separated)
        </label>
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags"
          placeholder="Example: Drilling, Coding, App Development, etc" value="{{old('tags')}}" />
